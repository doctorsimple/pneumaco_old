...
sub AcceptOrder {
	...
	if ($nav_top) {
	print "<table border=0 cellpadding=0 cellspacing=0 style='color:yellow'><tr> \n";
	...
	if ($menu_home_bottom) {
	print "<td valign=top nowrap><a href=\"$menu_home_bottom_url\" target='_top'>$menu_home_bottom</a></td> \n";}
	...
	if ($msg_n) {
	print "<font size=2>If you changed any quantities, please click ";
	print "<strong>update quantity </strong> before proceeding to ";
...
sub PreviewInformation {
	...
	print "<td  width=95% style='color:yellow'>$preview_heading \n";
	...
	print "<td width=95% style='color:yellow'>$preview_text \n";
	...
	if ($use_state_list) {
	print "<select name=\"Ecom_ShipTo_Postal_StateProv\"> \n";
...
sub PreviewOrder {
	...
	print "$returntofont \n";
		...
		# start edit link
		# start edit link
		# THIS IS DISABLED BY COMMENTING OUT THE INCREMENT LINES
	...
	print "<table border=0 cellpadding=1 cellspacing=0 width=50% bgcolor='#dcdcdc'> \n";
	...
	print "<table border=0 cellpadding=1 cellspacing=0 width=100% width=90% bgcolor='#dcdcdc'> \n";
	print "<tr><td align=right width=80% nowrap>$totaltext \n";
	print "Sales tax $TaxRate\% \(on $currency $AdjustedTax taxable\) ----> </font>\n";
	print "</td><td bgcolor=$totalback align=right width=20% nowrap> ";
	print "$totalcolor $currency $Tax </font></td></tr></table> \n";
