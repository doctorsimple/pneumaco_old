...
<link rel=StyleSheet type="text/css" href="http://bandbstudios.com/bandbcatpage.css" title="catalogstyle">
...
<h3>Image Catalog - Musicians A-C</h3>
<p><b>Each listing in the catalog shows locations and dates of photo shoots done with that artist. 
NOJHF is the New Orleans Jazz Heritage Festival, MS is Mountain Stage.
<p>Click on the artist's name to see a a thumbnail of the print. You can also do a <a href="http://bandbstudios.com/bindex5.html" target="_top">name search</a>. We also have many images that have not been scanned yet - <a href="http://bandbstudios.com/notscannedyet.html" target="_top">click here</a> to see a list of them.</p>
...
<p>
<table border="1" cellpadding="4" style="font-size:14pt;font-weight:bold">
<tr>
...
<form name="catalog" action="http://www.bandbstudios.com/orderoptions.html" method="get">
