...
$html_title  = 'B and B Studios Online Image Collection';
...
# not be as nice). See the README for more info.
	...
	<TABLE WIDTH="450" CELLPADDING=0 CELLSPACING=0 BORDER=1 BGCOLOR="#FFFFCC">
	 <TR>
				<TD align="right" valign="top" width="150"><$font>Num ID:</font></td>
				<TD VALIGN="TOP" WIDTH="475">&nbsp;<INPUT TYPE="TEXT" NAME="NumID" size="40" VALUE="$rec{'NumID'}" SIZE="7" MAXLENGTH="255"></TD></TR>
        <TR><TD ALIGN="Right" VALIGN="TOP" WIDTH="150"><$font>ID Number:</FONT></TD>
                <TD VALIGN="TOP" WIDTH="475">&nbsp;<INPUT TYPE="TEXT" NAME="ID" size="40" VALUE="$rec{'ID'}" SIZE="3" MAXLENGTH="255"></TD></TR>
        <TR><TD ALIGN="Right" VALIGN="TOP"><$font>Filename:</FONT></TD>
                <TD VALIGN="TOP">&nbsp;<INPUT TYPE="TEXT" NAME="filename" VALUE="$rec{'filename'}" SIZE="40" MAXLENGTH="255"></TD></TR>
		<tr><td valign="top"></td>
			<td valign="top"><img src="http://bandbstudios.com/Pictures/$rec{'filename'}"></td></tr>
        <TR><TD ALIGN="Right" VALIGN="TOP"><$font>Venue: </FONT></TD>
                <TD VALIGN="TOP">&nbsp;<INPUT TYPE="TEXT" NAME="venue" VALUE="$rec{'venue'}" SIZE="40" MAXLENGTH="255"></TD></TR>

        <TR><TD ALIGN="Right" VALIGN="TOP"><$font>Date:</font></td>
		<td valign="top">&nbsp;<Input type="text" name="date" value="$rec{'date'}" size="10"> </FONT></TD></tr>
                
		<tr><td align="right"" valign="top"><$font>Artist Name:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k1" value="$rec{'k1'}" size="40"></font></td></tr>
			<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k2" value="$rec{'k2'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k3" value="$rec{'k3'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k4" value="$rec{'k4'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k5" value="$rec{'k5'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k6" value="$rec{'k6'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k7" value="$rec{'k7'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k8" value="$rec{'k8'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k9" value="$rec{'k9'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k10" value="$rec{'k10'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k11" value="$rec{'k11'}" size="40"></font></td></tr>
		<tr><td align="right"" valign="top"><$font>Keyword:</font></td>
		<td valign="top">&nbsp;<input type="text" name="k12" value="$rec{'k12'}" size="40"></font></td></tr>
...
# be displayed will be in the %rec hash.
	...
	<TR><TD ALIGN="Right" VALIGN="TOP" WIDTH="20%"><$font_color>ID Number:</FONT></TD>
		<TD WIDTH="80%">&nbsp;<$font>$rec{'ID'}</Font></TD></TR>
	<TR><TD ALIGN="Right" VALIGN="TOP"><$font_color>Artist:</FONT></TD>
		<TD width="80%">
		$rec{'k1'}<br>
		<img src="http://bandbstudios.com/Pictures/$rec{'filename'}"></font></TD></TR>
	<TR><TD ALIGN="Right" VALIGN="TOP"><$font_color>Venue: </FONT></TD>
		<TD>&nbsp;<$font>$rec{'venue'}</Font></TD></TR>
	<TR><TD ALIGN="Right" VALIGN="TOP"><$font_color>Date:</FONT></TD>
		<TD>&nbsp;<$font>$rec{'date'}</Font></TD></TR>
		<TR><td align="center" colspan="2"><input type="submit" value="Buy this Print" onClick="passdata('$rec{'ID'}')"></td></TR>
	</TABLE>
	|;
}
...
# The database manager home page.
	...
	print  qq|
<html>
<head><base href="http://bandbstudios.com">
	<title>$html_title</title>
	<link rel=StyleSheet type="text/css" href="bandb.css" title="BandBstyle">
</head>
	...
	<center>
		<table border=1 bgcolor="#ffffff" cellpadding=5 cellspacing=3 width=500 align=center valign=top>
			<tr><td colspan=2 bgcolor="black">
                    ...
                    <Span style="color:yellow;font-family:sans-serif;font-size:12pt">$html_title: Main Menu</span>
			</td></tr>
			<tr><td>
...
#
	...
	print qq!| <A HREF="http://bandbstudios.com" target="_top">Home</A> !;
	print qq!| <A HREF="$db_script_link_url&add_form=1">Add</A> ! 				    if ($per_add);
	print qq!| <A HREF="http://bandbstudios.com/bindex5.html" target="_top">Search</A> ! 				if ($per_view);
	...
	print qq!| <A HREF="$db_script_link_url&view_records=1&$db_key=*">List All</A> ! if ($per_mod);
	print qq!| <A HREF="$db_script_link_url&admin_display=1">Admin</A> ! 			if ($per_admin);
	print qq!| <A HREF="http://bandbstudios.com" target="_top">Log Off</A> |!;
	print qq!</font></p>!;
...
# a license. See: http://gossamer-threads.com/scripts/register/ for more info.
	print qq!	
		<table border=0 width=100%>
			<tr><td align=left>&nbsp;</td>
				<td align=right><a href="http://www.gossamer-threads.com/scripts/dbman/" target="_blank"><img src="widgets/powered.gif" border=0 width=100 height=31 alt="Database Powered by Gossamer Threads Inc."></a></td></tr>
		</table>
<p><div class="menu">  <a href="alphacatpages.pl">Browse Catalog</a> &nbsp;-&nbsp;  <a href="postcards.html" target="_top">Postcards</a> &nbsp;-&nbsp; <a href="multimagegallery.html" target="_top">MultiPanels</a>  &nbsp;-&nbsp; <a href="catalogothers.html">Others catalog</a></div>
	!;
}	
...
#
	...
	<INPUT TYPE="TEXT" NAME="keyword" SIZE=15 MAXLENGTH=255> Enter the name you are looking for</FONT><BR>
...
<body bgcolor="black" onload="document.forms[0].ID.focus()">
	...
	<center>
		<table border=1 bgcolor="#ffffff" cellpadding=5 cellspacing=3 width=500 align=center valign=top>
			<tr><td colspan=2 bgcolor="black">
                    ...
                    <span style="color:yellow;font-family:sans-serif;font-size:12pt>$html_title: Add a New Record</span>
			</td></tr>
			<tr><td>
					<p><center><$font_title><b>
						Add a New Record
        ...
        <TR>
				<TD align="right" valign="top" width="150"><$font>Num ID:</font></td>
				<TD VALIGN="TOP" WIDTH="475">&nbsp;<INPUT TYPE="TEXT" NAME="NumID" size="40" VALUE="$rec{'NumID'}" SIZE="7" MAXLENGTH="255"></TD></TR>
				<TD ALIGN="Right" VALIGN="TOP" WIDTH="150"><$font>ID Number:</FONT></TD>
                <TD VALIGN="TOP" WIDTH="475">&nbsp;<INPUT TYPE="TEXT" NAME="ID" size="40" VALUE="$rec{'ID'}" SIZE="3" MAXLENGTH="255"></TD></TR>
        <TR><TD ALIGN="Right" VALIGN="TOP"><$font>Filename:</FONT></TD>
                <TD VALIGN="TOP">&nbsp;<INPUT TYPE="TEXT" NAME="filename" VALUE="$rec{'filename'}" SIZE="40" MAXLENGTH="255"></TD></TR>
		<tr><td valign="top"></td>
...
<head><base href="http://bandbstudios.com">
	...
	<link rel=StyleSheet type="text/css" href="bandb.css" title="catalogstyle">
</head>
...
<head><base href="http://bandbstudios.com">
	...
	<link rel=StyleSheet type="text/css" href="bandb.css" title="catalogstyle">
	 if (!parent.menu)
	  	{window.location="bindex5.html"}
</head>

<body bgcolor="black" onload="document.aform.keyword.focus()">
	<form action="$db_script_url" method="GET" name="aform">
		<input type=hidden name="db" value="$db_setup">
		<input type=hidden name="uid" value="$db_uid">	
	<center>
		<table border=1 bgcolor="#ffffff" cellpadding=5 cellspacing=3 width=500 align=center valign=top>
			<tr><td colspan=2 bgcolor="black">
					<FONT FACE="MS Sans Serif, arial,helvetica" size=1 COLOR="#FFFFFF">
                     <span style="color:yellow;font-family:sans-serif;font-size:12pt">$html_title: Search the Database</span>
			</td></tr>
			<tr><td>
					<p><center><$font_title><b>
						Search the Database
					...
					<p><center> <INPUT TYPE="SUBMIT" NAME="view_records" VALUE="View Records"></center></p>
...
<p><div class="menu">  <a href="alphaindex.html">Browse Catalog</a>  &nbsp;-&nbsp; <a href="postcards.html" target="_top">Postcards</a> &nbsp;-&nbsp; <a href="multimagegallery.html" target="_top">MultiPanels</a>  &nbsp;-&nbsp; <a href="catalogothers.html">Others catalog</a></div>
...
<body bgcolor="black">
<form name="catalog" action="orderoptions.php" method="get" target="_top">
<input type="hidden" name="artist">
	<blockquote>
	<table border=1 bgcolor="#ffffff" cellpadding=5 cellspacing=3 width=500 valign=top>
		<tr><td colspan=2 bgcolor="black"><FONT FACE="MS Sans Serif, arial,helvetica" size=1 COLOR="#FFFFFF">
...
# html_record for printing.
	...
	print qq|
		<p>
		<table border=0 bgcolor="black" cellpadding=5 cellspacing=3 width=500 valign=top>
	...
	<center>
		<table border=1 bgcolor="#ffffff" cellpadding=5 cellspacing=3 width=500 align=center valign=top>
			...
			<tr><td>
					...
					<$font>
						<P>Nothing was found that matched your query. Please note that spelling must be exact -  If you're not sure, try a couple of variations on the name (e.g., 'Mike' and 'Michael')</p><p>
...
<body bgcolor="black" onload="document.aform.ID.focus()">
	<form action="$db_script_url" method="GET" name="aform">
		<input type=hidden name="db" value="$db_setup">
		<input type=hidden name="uid" value="$db_uid">
...
<body bgcolor="black" text="#000000" onLoad="document.form1.userid.focus()">
...
<body bgcolor="#DDDDDD" text="#000000">
	...
	<center>
		<table border=1 bgcolor="#ffffff" cellpadding=5 cellspacing=3 width=500 align=center valign=top>
			<tr><td colspan=2 bgcolor="black">
					<FONT FACE="MS Sans Serif, arial,helvetica" size=1 COLOR=black>
