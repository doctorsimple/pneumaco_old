...
$my_email = "masks@frontier.com,doctorsimple@gmail.com";
...
$continue = "https://pneumaco.com/secure/illusion/thankyou.htm";
...
$headers = "From: securesection@pneumaco.com";

$whathappen = mail($my_email,$subject,$message,$headers);
if ($whathappen == true) {$wassent="Mailed!";}
$mylog = fopen("logthemail.php","a");
fwrite($mylog, "STARTLOG(".$wassent.") \r\n".$my_email."\r\n".$message."\r\n".$headers."\r\nENDLOG\r\n");
fclose($mylog);
