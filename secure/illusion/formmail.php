...
//$recipient = "masks@verizon.net"; // youremail@domain.com
//$email="masks@verizon.net";
...
// reside on.
$referers = array ('illusionmasks.com','www.illusionmasks.com','pneumaco.com','www.pneumaco.com');

// banned emails, these will be email addresses of people
// who are blocked from using the script (requested)
$banlist = array ('user@domain.com', 'etc@domains.com');
...
function mail_it($content, $subject, $email, $recipient) {
   ...
   $headers .= "From: masks@pneumaco.com\n"; 
