...
sub SaveInvoiceFile {
	...
	<tr Class="rowTopMessage"><td><b>This is a Web Copy of the invoice information for this Order.</b> If paid by Credit Card, the Credit Card Information is safely</td></tr>
	<tr><td Class="cellTopMessage">
	stored on our Secure Server.   If being paid by Check or by Phone, the check is now being mailed or called into the Business offices. 
	<blockquote>
