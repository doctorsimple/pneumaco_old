...
if (exists ($shipping_destination_fields{'Ecom_ShipTo_Telecom_Fax_Number'})) {
	...
	print "<tr><td width=5% nowrap><font size=3><strong>$itm_n.</strong></font></td> \n";
	print "<td  width=95%>$preview_heading \n";
	print "<strong>We Try To Choose The Best Shipping Method for Your Order.</strong></font>";
	print "<font color=red size=1> EDITING</font>" if ($msg_function eq "EDITING");
	print "</td></tr> \n";

	print "<tr><td width=5%><br></td> \n";
	print "<td width=95%>$preview_text \n";
	print "When we Finalize your order in our Offices, we adjust the shipping ";
	print "for delivery in 2 to 5 days</font></td></tr>\n";

            print "<tr><td width=5%><br></td> \n";
	print "<td width=95%>$preview_text \n";
	print "And we also choose shipping charges to reflect ";
	print "how far you are from us!  </font></td></tr>\n";

            print "<tr><td width=5%><br></td> \n";
	print "<td width=95%>$preview_text \n";
	print "Thus final Shipping Charges may alter slightly due to  ";
	print "distance and weight!  </font></td></tr>\n";

            print "<tr><td width=5%><br></td> \n";
	print "<td width=95%>$preview_text \n";
	print "<font color=red >==>We Recommend that you choose 'Two to Four Day Service!'  </font></td></tr>\n";
